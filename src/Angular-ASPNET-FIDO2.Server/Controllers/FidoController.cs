using System.Text;
using Angular_ASPNET_FIDO2.Server.Domain;
using Fido2NetLib;
using Fido2NetLib.Objects;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace Angular_ASPNET_FIDO2.Server.Controllers
{
    ...
    public class FidoController : Controller
    {
        ...
        public ActionResult AssertionOptionsPost([FromForm] string username, [FromForm] string userVerification = null)
        {
            try
            {
